...
public class Del_CConnection {
	...
	public static Del_CConnection build(DataSource ds) throws SQLException {
		return build(ds, null);
	}

	public static Del_CConnection build(DataSource dataSource, Del_CConnection cconn) throws SQLException {
