 ...
 */
public class Map2 extends JSON implements Map<String, Object>, Cloneable, Serializable, InvocationHandler {
	...
	public Map2(Map<String, Object> map) {
		this.map = map;
	}

	public Map2(boolean ordered) {
		this(DEFAULT_INITIAL_CAPACITY, ordered);
	}

	public Map2(int initialCapacity) {
		this(initialCapacity, false);
	}

	public Map2(int initialCapacity, boolean ordered) {
		if (ordered) {
	...
	public Map2 fluentPut(String key, Object value) {
		map.put(key, value);
		return this;
	}
	...
	public Map2 fluentPutAll(Map<? extends String, ? extends Object> m) {
		map.putAll(m);
		return this;
	}
	...
	public Map2 fluentRemove(Object key) {
		map.remove(key);
		return this;
	}
